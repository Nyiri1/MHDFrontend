...
public class CustomView extends LinearLayout {
    ...
    protected void createWindowFrame(){
        ...
        float left = getWidth()*(1-DesW/(Ws*cropFactor))/2;
        Log.v("Debug6", "Berechnete Breite Transparenz: " + left);
        float top = getHeight()*(1-DesH/(Hs*cropFactor))/2;
        Log.v("Debug6", "Berechnete Höhe Transparenz: " + top);
        //links oben rechts unten
        float right = getWidth()-left;
        float bottom = getHeight() - top;
        //left top right bottom
        Log.v("Debug6", "Rectangle: " + left + ", " + top + ", " + right + ", " + bottom);
